...
export type Fileish = (File | string | NamedString);
export type FileListish = (Fileish | Array<File | string>);
...
export type Styles = (Record<string, string> & ((...names: string[]) => string));
