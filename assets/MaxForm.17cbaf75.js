import { g as forwardRef, v as useMultiStyleConfig, t as omitThemingProps, ag as split, ah as layoutPropNames, a2 as mergeWith, r as react, c as chakra, a as jsx, a4 as dataAttr, h as cx, e as useWeb3, b as useNavigate, j as jsxs, F as Fragment, ai as nftBase, R as React, U as NETWORKS, a1 as Spinner } from "./index.35c474d9.js";
import { r as regexify, e as extractMessage, S as Stack, B as Box, n as isSet, l as lib, o as ipfsify, p as isEmpty, q as createIcon, U as UnorderedList, s as ListItem, F as Flex, u as SimpleGrid, b as Tooltip, h as httpURL, c as Center, v as Link, R as ReactMarkdown, T as Text, d as Table, f as Thead, g as Tr, i as Th, j as Tbody, k as Td, w as switchTo, x as capitalize } from "./LinkedSVG.4242533a.js";
import { u as useForm, I as Input } from "./index.esm.6e1e3c53.js";
import { u as useFormControl, F as FormControl, a as FormLabel, B as Button } from "./chakra-ui-form-control.esm.c27e1ea4.js";
import { u as useToast, T as Tabs, a as TabList, b as Tab, c as TabPanels, d as TabPanel, R as RadioGroup, e as Radio, f as Textarea } from "./chakra-ui-toast.esm.e52c4295.js";
import { I as Image$1 } from "./chakra-ui-image.esm.74a35fbd.js";
function _extends() {
  ...
  return /* @__PURE__ */ jsxs(UnorderedList, {
    ...
    children: [/* @__PURE__ */ jsx(ListItem, {
      ...
      children: /* @__PURE__ */ jsxs(FormControl, {
        ...
        children: [/* @__PURE__ */ jsxs(Flex, {
        ...
        }), images?.length && /* @__PURE__ */ jsx(RadioGroup, {
          ...
          children: /* @__PURE__ */ jsx(SimpleGrid, {
            ...
            children: images.map((image, idx) => {
              const name = image instanceof File ? image.name : image.replace(/^.*\//g, "");
      ...
      if (processing || working) {
        return /* @__PURE__ */ jsxs(Flex, {
          children: [/* @__PURE__ */ jsx(Spinner, {}), /* @__PURE__ */ jsxs(Text, {
            ml: 2,
            children: [capitalize(purpose).slice(0, -1), "ing\u2026"]
          })]
        });
...
//# sourceMappingURL=MaxForm.17cbaf75.js.map
