import { o as getDefaultExportFromCjs, m as getAugmentedNamespace, R as React, P as PropTypes } from "./index-23392436.js";
...
var encode_1 = encode;
const normalize$1 = /* @__PURE__ */ getDefaultExportFromCjs(encode_1);
...
function imageReference(h2, node) {
  ...
  const props = { src: normalize$1(def.url || ""), alt: node.alt };
...
function image(h2, node) {
  const props = { src: normalize$1(node.url), alt: node.alt };
...
function linkReference(h2, node) {
  ...
  const props = { href: normalize$1(def.url || "") };
  if (def.title !== null && def.title !== void 0) {
    props.title = def.title;
  }
...
function link(h2, node) {
  const props = { href: normalize$1(node.url) };
  if (node.title !== null && node.title !== void 0) {
    props.title = node.title;
  }
  return h2(node, "a", props, all(h2, node));
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(inlineStyleParser);
...
//# sourceMappingURL=react-markdown-84de2d25.js.map
