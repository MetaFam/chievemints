import { n as ne$1, s as se$1, T as T$2, t as te$1, a as a$2, o as oe$1, R as R$1, p as p$1, y as y$1 } from "./index-aecccb24.js";
import { aI as browser } from "./index-f164924e.js";
class MotionValue {
...
const c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o3) {
  ...
  const { walletConnectUri: o3 } = p$1.state, { mobile: r2, name: a2 } = e2, t2 = r2?.native, l2 = r2?.universal;
  ...
  const { desktop: e2, mobile: o3 } = a$2.getWalletRouterData(), r2 = Boolean(e2?.native), a2 = Boolean(e2?.universal), t2 = Boolean(o3?.native) || Boolean(o3?.universal);
...
const G = { manualWallets() {
  var e2, o3;
  const { mobileWallets: r2, desktopWallets: a2 } = y$1.state, t2 = (e2 = G.recentWallet()) == null ? void 0 : e2.id, l2 = a$2.isMobile() ? r2 : a2, i2 = l2?.filter((s2) => t2 !== s2.id);
  return (o3 = a$2.isMobile() ? i2?.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, mobile: f2, links: f2 })) : i2?.map(({ id: s2, name: $2, links: f2 }) => ({ id: s2, name: $2, desktop: f2, links: f2 }))) != null ? o3 : [];
}, recentWallet() {
...
let me = class extends s {
  ...
  onFormatAndRedirect(e2) {
    const { desktop: o3, name: r2 } = a$2.getWalletRouterData(), a2 = o3?.native;
    if (a2) {
...
let he = class extends s {
  ...
  onFormatAndRedirect(e2, o3 = false) {
    const { mobile: r2, name: a2 } = a$2.getWalletRouterData(), t2 = r2?.native, l2 = r2?.universal;
    if (t2 && !o3) {
  ...
  render() {
    const { name: e2, id: o3, image_id: r2, app: a2, mobile: t2 } = a$2.getWalletRouterData(), { isWeb: l$12 } = c.getCachedRouterWalletPlatforms(), i2 = a2?.ios, s2 = t2?.universal;
...
let we = class extends s {
  ...
  onFormatAndRedirect(e2) {
    const { desktop: o3, name: r2 } = a$2.getWalletRouterData(), a2 = o3?.universal;
    if (a2) {
...
//# sourceMappingURL=index-89523a19.js.map
