import { g as forwardRef, h as cx, r as react, c as chakra, a as jsx, j as jsxs, _ as __assign, i as __read, k as __extends, R as React, l as __rest, m as __spreadArray, n as __values, F as Fragment$1, o as __DEV__, p as createContext, q as mapResponsive, s as useStyleConfig, t as omitThemingProps, v as useMultiStyleConfig, w as getValidChildren, x as filterUndefined, y as isNull, z as tokenToCSSVar, A as isNumber, S as StylesProvider$1, B as useStyles$1, C as mergeRefs, D as useTheme, E as getCSSVar, G as isString$1, I as omit, J as pick, P as Portal$1, V as VisuallyHidden, K as useDisclosure, L as useId$1, M as useEventListener, N as callAllHandlers, O as px$1, Q as CID, T as ipfsLinkPattern, U as NETWORKS, W as itAll, X as ipfs, Y as getAugmentedNamespace, Z as getDefaultExportFromCjs, $ as propTypes, a0 as Link$1, a1 as Spinner } from "./index.35c474d9.js";
...
var Icon = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  if (element2 && typeof element2 !== "string") {
    return /* @__PURE__ */ react.exports.createElement(chakra.svg, _extends$4({
      as: element2
    }, shared, rest));
  }
...
var Container = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ react.exports.createElement(chakra.div, _extends$3({
    ...
    __css: _extends$3({}, styles, centerContent && {
      display: "flex",
...
var List = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ react.exports.createElement(StylesProvider, {
    ...
    role: "list",
    __css: _extends$3({}, styles.container, spacingStyle)
  }, rest), validChildren));
});
if (__DEV__) {
...
const switchTo = async (chain) => {
  ...
  try {
    ...
    if (switchError.code === 4902) {
      throw new Error(
        `The network \u201C${NETWORKS[chainId].name ?? "Unknown"}\u201D is not yet available in your MetaMask.
...
const extractMessage = (error) => error?.error?.message ?? error?.data?.message ?? error?.message ?? (typeof error === "string" ? error : `\u{1D47C}\u{1D48F}\u{1D48C}\u{1D48F}\u{1D490}\u{1D498}\u{1D48F} \u{1D46C}\u{1D493}\u{1D493}\u{1D490}\u{1D493}: ${lib.stringify(error, null, 2)}`);
...
function tokenizeCharacterReference(effects, ok2, nok) {
  ...
  function value(code2) {
    ...
    if (code2 === 59 && size) {
      ...
      if (test2 === asciiAlphanumeric && !decodeNamedCharacterReference(self.sliceSerialize(token2))) {
        return nok(code2);
      }
      effects.enter("characterReferenceMarker");
      effects.consume(code2);
...
const RouterLink$1 = chakra(Link$1);
const IdTd = ({
  token: token2
}) => /* @__PURE__ */ jsx(Td, {
  children: /* @__PURE__ */ jsx(Tooltip, {
    label: token2.id != null ? regexify(`0x${BigInt(token2.id).toString(16)}`) : "\u{1D684}\u{1D697}\u{1D694}\u{1D697}\u{1D698}\u{1D6A0}\u{1D697}",
...
const DescriptionTd = ({
  ...
  children: /* @__PURE__ */ jsx(ReactMarkdown, {
    linkTarget: "_blank",
    children: token2.metadata?.description ?? "*No Description*"
  })
});
const LinkTd = ({
  token: token2
}) => /* @__PURE__ */ jsx(Td, {
  children: token2.metadata?.external_url && /* @__PURE__ */ jsx(Link, {
...
const TotalTd = ({
  ...
  children: /* @__PURE__ */ jsx(RouterLink$1, {
    to: `/owners/${token2.id}`,
    children: token2.total == null ? /* @__PURE__ */ jsx(Spinner, {}) : `${token2.total} \u2044 ${token2.max}`
  })
});
const ActionsTd = ({
  token: token2
...
const RouterLink = chakra(Link$1);
...
//# sourceMappingURL=LinkedSVG.4242533a.js.map
