import { q as getDefaultExportFromCjs, ah as getAugmentedNamespace, ao as getLocation_1, ap as getLocalStorage_1, aq as getNavigator_1, ar as getFromWindow_1, as as getFromWindowOrThrow_1, at as getDocumentOrThrow_1, au as getDocument_1, av as getNavigatorOrThrow_1, aw as getLocationOrThrow_1, ax as getCryptoOrThrow_1, ay as getCrypto_1, az as getLocalStorageOrThrow_1, aA as detect, aB as getWindowMetadata_1, aC as require$$2$1, aD as require$$3$1, aE as require$$0$3, aF as require$$1$1, aG as browser$1, aH as EventEmitter } from "./index-f164924e.js";
import { s as safeJsonParse$1, a as safeJsonStringify$1, p as payloadId$1, c as cjs$1, I as IJsonRpcConnection, f as formatJsonRpcError, J as JsonRpcProvider, H as HttpConnection } from "./http-9c899682.js";
import { b as buffer } from "./index-12e3b384.js";
import { b, l, y, g as g$1, $ as $$1, q as q$1, B as B$1, E as E$1, a as y$1, h, p, V as V$1, s, _, A as A$1, F as F$1, T as T$1, c as q$2, x as x$1, d as F$2, e as _$1, P as P$1 } from "./hooks.module-42a01bdb.js";
...
const isTypedarray$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: _isTypedArray
}, [isTypedarray]);
const require$$0$2 = /* @__PURE__ */ getAugmentedNamespace(isTypedarray$1);
var isTypedArray$2 = require$$0$2.strict;
...
var queryString = {};
(function(exports) {
  const strictUriEncode = require$$0$3;
  const decodeComponent = require$$1$1;
  const splitOnFirst = require$$2$1;
  const filterObject = require$$3$1;
...
const index$2 = /* @__PURE__ */ getDefaultExportFromCjs(toggleSelection);
const toggleSelection$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index$2
}, [toggleSelection]);
const require$$0 = /* @__PURE__ */ getAugmentedNamespace(toggleSelection$1);
var deselectCurrent = require$$0;
...
const index$1 = /* @__PURE__ */ getDefaultExportFromCjs(copyToClipboard);
const copyToClipboard$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index$1
}, [copyToClipboard]);
const require$$2 = /* @__PURE__ */ getAugmentedNamespace(copyToClipboard$1);
function g(n, t) {
  for (var e in t)
    n[e] = t[e];
  return n;
...
(E.prototype = new b()).isPureReactComponent = true, E.prototype.shouldComponentUpdate = function(n, t) {
...
}, A = { map: k, forEach: k, count: function(n) {
...
l.unmount = function(n) {
  ...
  var i = e.__a && y(g$1, null, n.fallback);
  return i && (i.__u &= -33), [y(g$1, null, e.__a ? null : n.children), i];
};
...
function P(n) {
  ...
  } }), q$1(y(W, { context: e.context }, n.__v), e.l);
}
function j(n, e) {
  var r = y(P, { __v: n, i: e });
...
function q(n, t, e) {
  return null == t.__k && (t.textContent = ""), q$1(n, t), "function" == typeof e && e(), n ? n.__c : null;
}
function G(n, t, e) {
  return B$1(n, t), "function" == typeof e && e(), n ? n.__c : null;
}
...
l.vnode = function(n) {
  "string" == typeof n.type && function(n2) {
    ...
    "select" == e && u.multiple && Array.isArray(u.value) && (u.value = $$1(t.children).forEach(function(n3) {
      n3.props.selected = -1 != u.value.indexOf(n3.props.value);
    })), "select" == e && null != u.defaultValue && (u.value = $$1(t.children).forEach(function(n3) {
...
function an(n) {
  return fn(n) && n.type === g$1;
}
function sn(n) {
  return fn(n) ? E$1.apply(null, arguments) : n;
}
function hn(n) {
  return !!n.__k && (q$1(null, n), true);
}
function vn(n) {
...
var wn = { useState: h, useId: V$1, useReducer: s, useEffect: p, useLayoutEffect: y$1, useInsertionEffect: Sn, useTransition: bn, useDeferredValue: _n, useSyncExternalStore: Cn, startTransition: yn, useRef: _, useImperativeHandle: A$1, useMemo: F$1, useCallback: T$1, useContext: q$2, useDebugValue: x$1, version: "17.0.2", Children: A, render: q, hydrate: G, unmountComponentAtNode: hn, createPortal: j, createElement: y, createContext: F$2, createFactory: cn, cloneElement: sn, createRef: _$1, Fragment: g$1, isValidElement: fn, isElement: gn, isFragment: an, findDOMNode: vn, Component: b, PureComponent: E, memo: w, forwardRef: N, flushSync: pn, unstable_batchedUpdates: dn, StrictMode: mn, Suspense: L, SuspenseList: M, lazy: D, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: on };
...
var legacyUtils = require$$0$1;
var QRCode = _interopDefault(require$$1);
var copy = _interopDefault(require$$2);
var React = require$$3;
function open(uri) {
  QRCode.toString(uri, {
    type: "terminal"
...
//# sourceMappingURL=index-e5aa4af6.js.map
