import { T as Token, U as isDigit, V as isNameStart, W as dedentBlockStringLines, X as isNameContinue, Y as inspect, Z as devAssert, $ as Kind, a0 as OperationTypeNode, a1 as Location, a2 as __assign, r as reactExports, a3 as getApolloContext, a4 as invariant$1, a5 as canUseLayoutEffect, a6 as React, a7 as maybeDeepFreeze, a8 as NetworkStatus, a9 as canUseWeakMap, aa as equal, ab as compact, ac as mergeOptions, ad as __rest, ae as isNonEmptyArray, af as ApolloError, f as useParams, s as useSearchParams, ag as contractNetwork, u as useWeb3, e as jsx, F as Fragment, j as jsxs, L as Link } from "./index-f164924e.js";
import contractAddress from "./BulkDisbursableNFTs.address-1d795b30.js";
import { d as deregexify, c as capitalize, h as httpURL } from "./TokenFilterForm.module-7fdc84b3.js";
import { H as HomeLink } from "./HomeLink-0db95d25.js";
...
var useSyncExternalStore = realHook || function(subscribe, getSnapshot, getServerSnapshot) {
  ...
  if (
    ...
    globalThis.__DEV__ !== false && invariant$1.error(58);
  }
...
function parser(document) {
  ...
  invariant$1(!!document && !!document.kind, 59, document);
  var fragments = [];
  var queries = [];
  var mutations = [];
  var subscriptions = [];
  ...
  invariant$1(!fragments.length || queries.length || mutations.length || subscriptions.length, 60);
  invariant$1(
  ...
  invariant$1(definitions.length === 1, 62, document, definitions.length);
...
function useInternalState(client, query) {
  ...
  state.forceUpdateState = reactExports.useReducer(function(tick) {
    return tick + 1;
  }, 0)[1];
  return state;
}
var InternalState = (
  ...
  function() {
    ...
    InternalState2.prototype.useQuery = function(options) {
      ...
      var result = useSyncExternalStore(reactExports.useCallback(function(handleStoreChange) {
    ...
    InternalState2.prototype.createWatchQueryOptions = function(_a) {
      ...
      _a.onError;
      _a.defaultOptions;
      var otherOptions = __rest(_a, ["skip", "ssr", "onCompleted", "onError", "defaultOptions"]);
...
const Owners = () => {
  ...
  const [ownerships, setOwnerships] = reactExports.useState(null);
  const decId = tokenId ? BigInt(tokenId).toString(10) : null;
  const query = reactExports.useMemo(() => ownersQuery[contractNetwork], []);
  const [
    search,
    {
      loading,
  ...
  const [title, setTitle] = reactExports.useState("𝘜𝘯𝘬𝘯𝘰𝘸𝘯");
  const { ensClient, roContract } = useWeb3();
  const [error, setError] = reactExports.useState(
    query == null ? `Retrieving owners requires access to a subgraph & one hasn’t been configured for the  ${capitalize(contractNetwork)} network.` : queryError
  );
  reactExports.useEffect(
  ...
  return /* @__PURE__ */ jsxs("section", { children: [
    ...
    error && /* @__PURE__ */ jsxs("div", { className: "error", children: [
      /* @__PURE__ */ jsx("span", { children: "¡Error!" }),
      ":",
      /* @__PURE__ */ jsx("span", { children: error })
    ] }),
    ownerships.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "warning", children: [
      /* @__PURE__ */ jsx("span", { children: "¡Empty!" }),
      ":",
    ...
    ] }) : /* @__PURE__ */ jsx("ol", { start: Number(offset) + 1, children: ownerships.map(({ owner, quantity }, idx) => /* @__PURE__ */ jsx("li", { children: `${owner} (${quantity})` }, idx)) }),
    ownerships.length === LIMIT && /* @__PURE__ */ jsx(
      Link,
      {
        to: {
...
//# sourceMappingURL=owners-f9fce460.js.map
