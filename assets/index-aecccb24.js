import { _ as __vitePreload } from "./index-f164924e.js";
const t = Symbol();
...
const N = a.isMobile(), d$1 = proxy({ wallets: { listings: [], total: 0, page: 1 }, search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] }), te = { state: d$1, async getRecomendedWallets() {
  ...
  return new Promise((t2) => {
    ...
    if (a.removeWalletConnectDeepLink(), p.setWalletConnectUri(e?.uri), p.setChains(e?.chains), T.reset("ConnectWallet"), s2 && n)
      I.open = true, t2();
    else {
      const i = setInterval(() => {
        const l2 = p.state;
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-89523a19.js"), true ? ["assets/index-89523a19.js","assets/index-f164924e.js","assets/index-24068cbe.css"] : void 0);
...
//# sourceMappingURL=index-aecccb24.js.map
