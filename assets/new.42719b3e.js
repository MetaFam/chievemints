import { j as jsxs, a as jsx, H as HelmetExport, c as chakra, e as useWeb3, u as useSearchParams, r as react, a1 as Spinner, af as rolePermissions } from "./index.74129a3c.js";
import { H as Header } from "./Header.e6da7c9a.js";
import { O as OptionsForm } from "./MaxForm.ac9b92d7.js";
import { C as Container, F as Flex, e as extractMessage, c as Center, S as Stack, H as Heading, T as Text, d as Table, f as Thead, g as Tr, i as Th, b as Tooltip, j as Tbody, k as Td } from "./LinkedSVG.2c776b3b.js";
    ...
    const load = async () => {
      if (roContract) {
        ...
        const roles2 = await Promise.all(Array.from({
          length: numRoles
        }).map(async (_, idx) => await rolesLibrary.roleNameByIndex(idx + 1)));
        setRoles(roles2);
      }
    };
    load();
...
//# sourceMappingURL=new.42719b3e.js.map
