import { r as reactExports, R as React, h as reactDomExports, a as jsxs, j as jsx } from "./index-bd5631bf.js";
import { H as Hs, L as LinkedSVG } from "./TokenFilterForm.module-31c41608.js";
var top = "top";
var bottom = "bottom";
var right = "right";
var left = "left";
...
function TippyGenerator(tippy2) {
  function Tippy2(_ref) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, children ? /* @__PURE__ */ reactExports.cloneElement(children, {
...
var forwardRef = function(Tippy2, defaultProps2) {
  return /* @__PURE__ */ reactExports.forwardRef(function TippyWrapper(_ref, _ref2) {
    ...
    return (
      ...
      // some reason
      /* @__PURE__ */ React.createElement(Tippy2, Object.assign({}, defaultProps2, props), children ? /* @__PURE__ */ reactExports.cloneElement(children, {
        ref: function ref(node) {
...
const Tippy = index;
const Header = ({ links = { cup: "/new", sign: "/" }, ...props }) => /* @__PURE__ */ jsxs("header", { id: Hs.style, ...props, children: [
...
//# sourceMappingURL=Header-d3337687.js.map
